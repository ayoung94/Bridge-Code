			...
			<div class="container">
				...
				<div class="description text-center">
					<form action="${pageContext.request.contextPath}/profile/introductionUpdate.do?member_id=${profile.member_id}"
						...
						<textarea id="form-control" class="form-control" readonly="readonly" name="member_introduction" rows="4" cols="5">${profile.member_introduction }</textarea>
				...
				<script>
					$(function() {$('#profileModal').on('show.bs.modal',function(event) {
						...
						$("#introEdit").click(function(event) {
							...
							else {document.getElementById('introsubmit').submit();
							...
							<ul id="subimg">
								<c:if test="${loginSession.member_id == profile.member_id }">
									...
									<c:if test="${empty subimg.member_img1 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img1">
												<img src="${pageContext.request.contextPath}/resources/img/examples/addimage.png"
												class="img-thumbnail" />
										</a></li>
									</c:if>
									<c:if test="${!empty subimg.member_img1 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img1">
												<img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img1}"
												class="img-thumbnail" />
										</a></li>
									</c:if>
									<c:if test="${empty subimg.member_img2 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img2">
												<img src="${pageContext.request.contextPath}/resources/img/examples/addimage.png"
												class="img-thumbnail" />
										</a></li>
									</c:if>
									<c:if test="${!empty subimg.member_img2 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img2">
												<img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img2}"
												class="img-thumbnail" />
										</a></li>
									</c:if>
									<c:if test="${empty subimg.member_img3 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img3">
												<img src="${pageContext.request.contextPath}/resources/img/examples/addimage.png"
												class="img-thumbnail" />
										</a></li>
									</c:if>
									<c:if test="${!empty subimg.member_img3 }">
										<li><a href="#" data-toggle="modal" data-target="#profileModal" data-whatever="member_img3">
												<img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img3}"
												class="img-thumbnail" />
										</a></li>
									</c:if>
								...
								<c:if test="${loginSession.member_id != profile.member_id }">
									...
									<c:if test="${!empty subimg.member_img1 }">
										<li><img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img1}"
											class="img-thumbnail" /></li>
									</c:if>
									<c:if test="${empty subimg.member_img2 }">
										<li><img src="${pageContext.request.contextPath}/resources/img/examples/no-image.gif"
									...
									<c:if test="${!empty subimg.member_img2 }">
										<li><img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img2}"
											class="img-thumbnail" /></li>
									</c:if>
									<c:if test="${empty subimg.member_img3 }">
										<li><img src="${pageContext.request.contextPath}/resources/img/examples/no-image.gif"
									...
									<c:if test="${!empty subimg.member_img3 }">
										<li><img src="${pageContext.request.contextPath}/profile_img/${ profile.member_img3}"
											class="img-thumbnail" /></li>
									</c:if>
								</c:if>
							</ul>
